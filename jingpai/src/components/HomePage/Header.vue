            ...
            <div class="content">
                ...
                <div id="search" class="fl">
                    <div id="search-top">
                        ...
                        <img src="http://www.jingpai.com/themes/shopex_D/widgets/search/images/icon_search.png" alt="">
                    </div>
                    <ul id="search-bottom">
                        <li>热门搜索:</li>
                        <li>劲酒</li>
                ...
                <img src="http://www.jingpai.com/public/images/d9/0d/c8/ce2dcffa1f6f5518e46db29f13ae9515192a7694.jpg?1488762384"
                    alt="" style="margin-left: 70px;margin-right: 20px">
                <img src="http://www.jingpai.com/public/images/bb/cb/ff/3bfa9fe733e8927f5c5c1bc6bcb6ff6e8eb0f389.png?1475193532"
                    alt="">
            </div>
        ...
        <nav>
            <div class="content">
                <dl id="goods">
                    ...
                    <dd class="goodtype" id="shouye">首页
                    ...
                    <dd class="goodtype" id="huiyuan">会员专区
                        <img src="http://www.jingpai.com/public/app/b2c/statics/images/hot_tag-hot.png" alt="">
                    </dd>
...
<style lang="scss" scoped>
    ...
    nav {
        width: 100%;
        height: 40px;
        background: url(http://www.jingpai.com/themes/shopex_D/images/images/nav_bg.png) -150px 0px;
    }
