  ...
  <div>
    ...
    <div class="lbox">
      <div class="lb">
        ...
        <div class="pp"><b>品牌：</b>
          <span @click="test1()">劲牌</span><span @click="test2()">毛铺</span><span @click="test3()">枫林</span><span
            @click="test4()">金眼牌</span></div>

      </div>

      <div class="st">
        <button>默认</button> <button @click="sortByKey()">价格</button> <button @click="sortByKey6()">销量</button>
        <span>排序:</span>
        <select name="" id="">
      ...
      <div class="list">
        <ul>
          <li v-for="(value,index) in jinpais" :key=" 'tr1'+ index" v-show="show1" @click="todet(value.gid)">
          ...
          <li v-for="(value,index) in arr2" :key=" 'tr2'+  index" v-show="show2" @click="todet(value.gid)">
            <img :src="value.img" alt="" @click="navTo(value.url)">
            <a href="" v-text="value.title"></a>
            <span>￥{{value.price}}</span> <del>￥{{value.dprice}}</del>
            <div class="gw" @click="navTo(value.url)">加入购物车</div>
          ...
          <li v-for="(value,index) in arr3" :key=" 'tr3'+ index" v-show="show3" @click="todet(value.gid)">
            <img :src="value.img" alt="" @click="navTo(value.url)">
            <a href="" v-text="value.title"></a>
            <span>￥{{value.price}}</span> <del>￥{{value.dprice}}</del>
            <div class="gw" @click="navTo(value.url)">加入购物车</div>
          ...
          <li v-for="(value,index) in arr4" :key=" 'tr4'+ index" v-show="show4" @click="todet(value.gid)">
            <img :src="value.img" alt="" @click="navTo(value.url)">
            <a href="" v-text="value.title"></a>
            <span>￥{{value.price}}</span> <del>￥{{value.dprice}}</del>
            <div class="gw" @click="navTo(value.url)">加入购物车</div>
