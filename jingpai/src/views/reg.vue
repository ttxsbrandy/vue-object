<template>
  <div class="body">
    <header>
      <img
        alt
        src="https://cas.jingpai.com/tpcas/Public/images/headerImg.png"
        style="width:100%;padding-top: 30px;height:80px;"
        id="headImg-pc"
      />
    </header>
    ...
    <div class="container">
      <div>
        <form action method="get" class="forget-pwd">
          ...
          <dl class="sel-yzsj">
            <dt>
              <span class="required" style="color: red;">*</span>手机号：
            </dt>
            <dd>
              <input
                type="text"
              ...
              <p
                v-show="phoneshow"
                v-text="phonetext"
                :style="show?{color:'#195'}: {color:'red'}"
              >手机号格式不正确</p>
            </dd>
            <div class="clears"></div>
          </dl>
          <dl class="sel-yzsj" id="sel-yzsj">
            <dt>
              <span class="required" style="color: red;">*</span>验证码：
            </dt>
            <dd>
              <input
                type="text"
          ...
          <dl>
            <dt>
              <span class="required" style="color: red;">*</span>密码：
            </dt>
            <dd>
          ...
          <dl>
            <dt>
              <span class="required" style="color: red;">*</span>确认密码：
            </dt>
            <dd>
              <input
                type="password"
              ...
              <p
                class="passwordTip"
                v-text="pwd"
                :style="showpwd?{color:'#195'}: {color:'red'}"
              >两次密码不一样</p>
            </dd>
            <div class="clears"></div>
          </dl>
      ...
      <div style="text-align: center;color:#000;position: relative;top: 10px;width: 100%;">
        <span>客服电话：400-677-1988 0714-8761988</span>
        <br />
        <br />
